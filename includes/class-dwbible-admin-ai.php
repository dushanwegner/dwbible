<?php
/**
 * DwBible — AI Accessibility Admin Page
 *
...
class DwBible_Admin_AI {
    ...
    public static function render_page() {
        ...
        <div class="wrap">
            ...
            <style>
                .dwbible-ai-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin-top: 20px; }
                @media (max-width: 1200px) { .dwbible-ai-grid { grid-template-columns: 1fr; } }
                .dwbible-ai-card { background: #fff; border: 1px solid #c3c4c7; padding: 20px; border-radius: 4px; }
                .dwbible-ai-card h2 { margin-top: 0; padding: 0; font-size: 1.2em; }
                .dwbible-ai-card h3 { font-size: 1em; margin: 1.2em 0 0.4em; }
                .dwbible-ai-urls { background: #f0f0f1; padding: 12px 16px; border-radius: 3px; font-family: monospace; font-size: 12px; line-height: 1.8; word-break: break-all; position: relative; margin: 8px 0; }
                .dwbible-ai-urls a { text-decoration: none; }
                .dwbible-ai-copy-btn { position: absolute; top: 8px; right: 8px; padding: 4px 10px; font-size: 11px; cursor: pointer; background: #2271b1; color: #fff; border: none; border-radius: 3px; }
                .dwbible-ai-copy-btn:hover { background: #135e96; }
                .dwbible-ai-copy-btn.copied { background: #00a32a; }
                .dwbible-ai-stat { display: inline-block; background: #f0f0f1; padding: 4px 10px; border-radius: 3px; margin: 2px 4px 2px 0; font-size: 13px; }
                .dwbible-ai-stat strong { color: #1d2327; }
                .dwbible-ai-check { color: #00a32a; font-weight: bold; }
                .dwbible-ai-table { width: 100%; border-collapse: collapse; margin: 8px 0; }
                .dwbible-ai-table th, .dwbible-ai-table td { text-align: left; padding: 6px 10px; border-bottom: 1px solid #f0f0f1; font-size: 13px; }
                .dwbible-ai-table th { font-weight: 600; color: #50575e; }
                .dwbible-ai-full { grid-column: 1 / -1; }
            </style>

            <!-- Content Overview -->
            <div class="dwbible-ai-grid">

                <div class="dwbible-ai-card">
                    <h2>Content Available to AI</h2>
                    <p>
                        <span class="dwbible-ai-stat"><strong><?php echo $book_count; ?></strong> books × 3 translations</span>
                        <span class="dwbible-ai-stat"><strong><?php echo $prayer_count; ?></strong> prayers × 5 languages</span>
                        <span class="dwbible-ai-stat"><strong><?php echo $saint_count; ?></strong> saints</span>
                    </p>
                    <table class="dwbible-ai-table">
                ...
                <div class="dwbible-ai-card">
                    ...
                    <table class="dwbible-ai-table">
                        <tr><td><span class="dwbible-ai-check">&#10003;</span> <code>llms.txt</code> + <code>llms-full.txt</code></td><td>AI entry-point docs</td></tr>
                        <tr><td><span class="dwbible-ai-check">&#10003;</span> JSON API (chapter + single verse)</td><td>Machine-readable content</td></tr>
                        <tr><td><span class="dwbible-ai-check">&#10003;</span> JSON-LD structured data</td><td>Schema.org on every page</td></tr>
                        <tr><td><span class="dwbible-ai-check">&#10003;</span> BreadcrumbList schema</td><td>Bible &gt; Book &gt; Chapter</td></tr>
                        <tr><td><span class="dwbible-ai-check">&#10003;</span> <code>&lt;link rel="alternate"&gt;</code></td><td>JSON version of each page</td></tr>
                        <tr><td><span class="dwbible-ai-check">&#10003;</span> <code>&lt;link rel="help"&gt;</code></td><td>Points to llms.txt</td></tr>
                        <tr><td><span class="dwbible-ai-check">&#10003;</span> robots.txt (17 AI bots)</td><td>All crawlers allowed</td></tr>
                        <tr><td><span class="dwbible-ai-check">&#10003;</span> Server-rendered HTML</td><td>No JS dependency</td></tr>
                        <tr><td><span class="dwbible-ai-check">&#10003;</span> Page-specific <code>&lt;title&gt;</code></td><td>E.g. "Genesis 1 (Vulgate)"</td></tr>
                        <tr><td><span class="dwbible-ai-check">&#10003;</span> Citation fields in JSON</td><td>Pre-formatted attribution</td></tr>
                        <tr><td><span class="dwbible-ai-check">&#10003;</span> Cross-references</td><td>Same verse in other translations</td></tr>
                    </table>
                </div>
            ...
            document.addEventListener('click', function(e) {
                var btn = e.target.closest('.dwbible-ai-copy-btn');
                if (!btn) return;
                e.preventDefault();
    ...
    private static function render_url_block( $url, $id, $desc = '' ) {
        echo '<div class="dwbible-ai-urls">';
        echo '<a href="' . esc_url( $url ) . '" target="_blank">' . esc_html( $url ) . '</a>';
        if ( $desc !== '' ) {
            echo '<br><span style="color:#50575e;font-size:11px">' . esc_html( $desc ) . '</span>';
        }
        echo '<button class="dwbible-ai-copy-btn" data-copy="' . esc_attr( $url ) . '">Copy</button>';
        echo '</div>';
    }
}
